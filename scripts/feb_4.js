...
let targetPercentage = 0.20;
let amountPercentage = 0.25;
                ...
                if (contract.is_sold) {
                    ...
                    if (currentLossAmount < 0) {
                        if (lostCountInRow >= 2) {
                            ...
                            // let newTime = (getRandomNumber(10, 30) * 1000);
                        ...
                        if (currentProfitAmount >= targetAmount) {
                            ...
                            let newTime = (getRandomNumber(1, 2) * 1000);
                            setTimer(newTime);
                            setTimeout(() => {
                                reserParams();
                                reload();
...
function calculateNextStake(totalLoss, returnPercentage = 0.88) {
    ...
    let nextStake = (totalLoss / returnPercentage) + Number(targetAmount);
